...
| --------: | --------------------------------------------------- | ------------------------- |
|        43 | `components/internal/utils/cx.ts`                   | shared internal machinery |
|        40 | `dom-props.ts`                                      | library code              |
|        31 | `tokens/motion-tokens.ts`                           | the token vocabulary      |
|        23 | `engine/index.ts`                                   | the WAAPI engine          |
|        17 | `components/internal/hooks/use-controllable.ts`     | shared internal machinery |
