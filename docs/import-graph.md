...
| --------: | --------------------------------------------------- | ------------------------- |
|        36 | `components/internal/utils/cx.ts`                   | shared internal machinery |
|        33 | `dom-props.ts`                                      | library code              |
|        26 | `tokens/motion-tokens.ts`                           | the token vocabulary      |
|        17 | `components/internal/icon/Icon.tsx`                 | shared internal machinery |
|        16 | `engine/index.ts`                                   | the WAAPI engine          |
