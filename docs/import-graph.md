...
| --------: | ------ | ------- |
| 31 | `components/internal/utils/cx.ts` | shared internal machinery |
| 27 | `dom-props.ts` | library code |
| 21 | `tokens/motion-tokens.ts` | the token vocabulary |
| 15 | `components/internal/icon/Icon.tsx` | shared internal machinery |
| 14 | `components/internal/hooks/use-controllable.ts` | shared internal machinery |
| 14 | `motion/timing.ts` | the React motion layer |
...
| 9 | `motion/motion-timing.ts` | the React motion layer |
| 9 | `motion/presence.tsx` | the React motion layer |
| 8 | `motion/element.tsx` | the React motion layer |
| 8 | `motion/presets.ts` | the React motion layer |
| 7 | `components/internal/overlay/layer.tsx` | shared internal machinery |
| 6 | `motion/glide.tsx` | the React motion layer |
...
| 5 | `motion/use-motion.ts` | the React motion layer |
