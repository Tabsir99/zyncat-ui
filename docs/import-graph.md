...
| --------: | --------------------------------------------------- | ------------------------- |
|        37 | `components/internal/utils/cx.ts`                   | shared internal machinery |
|        34 | `dom-props.ts`                                      | library code              |
|        27 | `tokens/motion-tokens.ts`                           | the token vocabulary      |
|        17 | `components/internal/icon/Icon.tsx`                 | shared internal machinery |
|        17 | `engine/index.ts`                                   | the WAAPI engine          |
