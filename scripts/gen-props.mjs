...
const HAND_WRITTEN = new Set(['icon', 'toast', 'introduction', 'installation', 'mcp']);
...
const lines = [
  '/* Generated by scripts/gen-props.mjs from the built types in dist/types - run `pnpm docs:props`, do not edit by hand.',
...
if (checkOnly) {
  if (!existsSync(OUT) || readFileSync(OUT, 'utf8') !== content) {
    console.error('✗ apps/docs/content/props.generated.ts is out of date - run "pnpm docs:props".');
    process.exit(1);
  }
