...
<Collapse open={showRules}>
  <div>Additional scheduling rules for this batch.</div>
    ...
    props: [
      ...
      { name: 'innerClassName', type: 'string', description: 'Class applied to the inner measured wrapper element.' },
...
<Badge tone="warning" dot>Review pending</Badge>`,
    props: [
      ...
      { name: 'dot', type: 'boolean', default: 'false', description: 'Renders a leading status dot.' },
      {
        name: 'live',
        type: 'boolean',
        default: 'false',
      ...
      { name: 'icon', type: 'ReactNode', description: 'Optional leading icon node, overrides dot when both are set.' },
...
<StatusBadge status={currentStatus} morph />`,
    props: [
      ...
      { name: 'size', type: "'sm' | 'md'", default: "'md'", description: 'Inherited from Badge: badge size.' },
      {
        name: 'dot',
        type: 'boolean',
      ...
      { name: 'icon', type: 'ReactNode', description: 'Inherited from Badge: optional leading icon node.' },
      { name: '...rest', type: 'HTMLAttributes', description: 'All native span attributes.' },
    ],
  },
...
<CountBadge value={queued} roll tone="info" />`,
    props: [
      ...
      { name: 'size', type: "'sm' | 'md'", default: "'md'", description: 'Inherited from Badge: badge size.' },
      { name: 'dot', type: 'boolean', default: 'false', description: 'Inherited from Badge: leading status dot.' },
      {
        name: 'live',
        type: 'boolean',
        default: 'false',
